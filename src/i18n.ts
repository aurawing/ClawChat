...
const messages = {
  'zh-CN': {
    ...
    uploadingAction: '上传中...',
    uploadFailed: '上传失败',
    uploadReadingFile: '读取文件中...',
    uploadSending: '正在上传',
    attachmentTooLarge: '不支持5MB以上附件，请在工作空间上传',
  ...
  en: {
    ...
    uploadReadingFile: 'Reading file...',
    uploadSending: 'Uploading',
    attachmentTooLarge: 'Attachments over 5 MB are not supported. Please upload via workspace.',
